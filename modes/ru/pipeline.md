...
2. **Для каждого URL**:
   ...
   d. **Выполнить auto-pipeline**: Оценка A-F → Отчёт .md → PDF (если балл >= 6.0) → Трекер
   e. **Переместить из "Ожидающие" в "Обработанные"**: `- [x] #NNN | URL | Компания | Роль | Балл/10 | PDF ✅/❌`
...
- [x] #144 | https://hh.ru/vacancy/87654321 | BigCo | Backend | 4.2/10 | PDF ❌
```
