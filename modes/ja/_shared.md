...
**スコアの解釈：**
- 9.0+ → 強いマッチ、今すぐ応募を推奨
- 8.0-8.9 → 良好なマッチ、応募する価値あり
- 7.0-7.9 → まずまずだが理想ではない、特別な理由がある場合のみ応募
- 7.0 未満 → 応募非推奨（CLAUDE.md の Ethical Use を参照）
...
**評価時（Scoring）：**
- リモート次元がハイブリッドで県・国外：スコア **6.0**（2.0 ではない）
- スコア 2.0 は求人が明示的に「週 4-5 日出社必須、例外なし」と言っている場合のみ
